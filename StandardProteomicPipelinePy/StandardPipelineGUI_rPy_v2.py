...
class Application(tk.Frame):
    ...
    def choosedir(self):
        ...
        self.Norm = tk.IntVar()
        self.NormVar = tk.StringVar()
        self.Quant = tk.IntVar()
        self.QuantVar = tk.StringVar()
        ...
        self.Exp = tk.OptionMenu(self, self.ExpVar, "Proteomic", "Phospho", "Proteomic+Phospho")
        self.ExpVar.set("Proteomic")
        self.Norm = tk.OptionMenu(self, self.NormVar, "MedianCentre", "Quantile")
        self.NormVar.set("MedianCentre")
        self.Quant = tk.OptionMenu(self, self.QuantVar, "Intensity", "LFQ")
        self.QuantVar.set("Intensity")
        ...
        self.Exp.grid(row=0, column=0, columnspan = 2, padx=60, pady=20, sticky=tk.N + tk.S + tk.E + tk.W)
        self.Quant.grid(row=1, column=0, columnspan = 2, padx=60, pady=20, sticky=tk.N + tk.S + tk.E + tk.W)
        self.Norm.grid(row=2, column=0, columnspan = 2, padx=60, pady=20, sticky=tk.N + tk.S + tk.E + tk.W)
        ...
        # self.MedianCentre.grid(row=2, column=0, padx=20, pady=20, sticky=tk.N + tk.S + tk.E + tk.W)
        # self.Quantile.grid(row=2, column=1, padx=20, pady=20, sticky=tk.N + tk.S + tk.E + tk.W)

        self.DirButton.grid(row=3, column=0, columnspan = 2, padx=20, pady=10, sticky=tk.S)
        self.note.grid(row=3, column=0, columnspan = 2, padx=20, pady=20, sticky=tk.N)

        self.NormButton.grid(row=4, column=0, padx=20, pady=20, sticky=tk.N + tk.S + tk.E + tk.W)
        self.StartButton.grid(row=4, column=1,padx=20, pady=20, sticky=tk.N + tk.S + tk.E + tk.W)

        self.quitButton.grid(row=5, column=1, padx=20, pady=20, sticky=tk.N + tk.S + tk.E + tk.W)

        self.version.grid(row=6, column=0,  padx=0, pady=0, sticky=tk.S + tk.W)
    ...
    def ExecuteNormalise(self):
        ...
        #
        r.assign("Exp_type", self.ExpVar.get())
        r.assign("Quant_type", self.QuantVar.get())
        r.assign("Norm_type", self.NormVar.get())

        robjects.r('''
        source("../2_dataPreprocess.R")
        dataPreprocess(txt_path, Quant_type, Norm_type)
        ''')
    ...
    def directoryOpen(self):
        ...
        r.assign( "txt_path", self.directory)

        try:
            os.makedirs(self.directory+'/temp')
        except OSError:
