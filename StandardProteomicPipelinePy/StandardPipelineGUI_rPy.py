...
class Application(tk.Frame):
    ...
    def choosedir(self):
        ...
        self.Norm = tk.OptionMenu(self, self.NormVar, "Proteomic", "Phospho", "Proteomic+Phospho")
        self.NormVar.set("Proteomic")
        ...
        self.Norm.grid(row=0, column=0, padx=20, pady=20, sticky=tk.N + tk.S + tk.E + tk.W)
        self.Quant.grid(row=0, column=1, padx=20, pady=20, sticky=tk.N + tk.S + tk.E + tk.W)
    ...
    def ExecuteNormalise(self):
        ...
        #
        r.assign("N_type", self.Norm)
        r.assign("Q_type", self.Quant)
